...
public class WizardLog implements Log {
  ...
  public void trace(LogState state, Throwable throwable) {
    ...
    if (throwable.getCause() != null)
      traceElements.addAll(Arrays.stream(throwable.getCause().getStackTrace()).toList());
    ...
    this.writeConfiguration(this.convertStackTraceToStrings(throwable.getMessage() != null ? throwable.getMessage() : "-/-",
      traceElements));
  }
  ...
  private List<String> convertStackTraceToStrings(
    String message,
